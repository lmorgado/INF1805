...
function love.load()
  ...
  table.insert(vButton,Button:create(width/2+20, heigth/3, 50, 30, "enviar",connect))
  vLabel = {}
  vLabel["text"] = Label:create(width/4, heigth/3, 30, 200, "love-client")
  vLabel["client"] = Label:create(width/2, 7*heigth/12, 30, 150, "Client: nil")
  vLabel["latitude"] = Label:create(width/2, 8*heigth/12, 30, 150, "Latitude:0.0")
  vLabel["longitude"] = Label:create(width/2, 9*heigth/12, 30, 150, "Longitude:0.0")
end
